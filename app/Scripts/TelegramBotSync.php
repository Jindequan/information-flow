...
use App\Services\Platform\TelegramBotAPI;

class TelegramBotSync extends Base {
    ...
    private function saveArticlesToTg($htmls) {
        foreach ($htmls as $html) {
            $this->api->sendHtmlFile($html);
        }
    }
